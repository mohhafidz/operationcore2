...
class DashboardOverall extends ConsumerWidget {
  final TextEditingController dayController;
  const DashboardOverall({super.key, required this.dayController});
                    ...
                    data: (d) {
                      return Row(
                        ...
                        children: [
                          ...
                          CircularGauge(percentage: d.soAchv, label: "SO ACHV"),
                          CircularGauge(percentage: d.smAchv, label: "SM ACHV"),
                          CircularGauge(
          ...
          widget: Column(
            children: [
              ...
              DetailTableRow(
                ...
                values: [
                  TableValue(
                    "${numberFormatter.format(siuResults.achievementPercentage)}%",
                  ),
                  TableValue(
                    "${numberFormatter.format(jasaResults.achievementPercentage)}%",
                  ),
                  TableValue(
                    "${numberFormatter.format(oilResults.achievementPercentage)}%",
                  ),
                  TableValue(
                    "${numberFormatter.format(partResults.achievementPercentage)}%",
                  ),
                  TableValue(
                    "${numberFormatter.format(sorderResults.achievementPercentage)}%",
                  ),
                  TableValue(
                    "${numberFormatter.format(materialResults.achievementPercentage)}%",
                  ),
                  TableValue(
                    "${numberFormatter.format(totalResults.achievementPercentage)}%",
                  ),
                  TableValue(
                    "${numberFormatter.format(bookingResults.achievementPercentage)}%",
                  ),
                  const TableValue(""),
                ],
              ),
              ...
              DetailTableRow(
                ...
                values: [
                  TableValue(
                    "${numberFormatter.format(siuResults.averagePerHari)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(jasaResults.averagePerHari)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(oilResults.averagePerHari)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(partResults.averagePerHari)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(sorderResults.averagePerHari)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(materialResults.averagePerHari)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(totalResults.averagePerHari)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(bookingResults.averagePerHari)}",
                  ),
                  const TableValue(""),
                ],
              ),
              ...
              DetailTableRow(
                ...
                values: [
                  TableValue(
                    "${numberFormatter.format(siuResults.sisaTargetValue)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(jasaResults.sisaTargetValue)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(oilResults.sisaTargetValue)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(partResults.sisaTargetValue)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(sorderResults.sisaTargetValue)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(materialResults.sisaTargetValue)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(totalResults.sisaTargetValue)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(bookingResults.sisaTargetValue)}",
                  ),
                  const TableValue(""),
                ],
              ),
              ...
              DetailTableRow(
                ...
                values: [
                  TableValue(
                    "${numberFormatter.format(siuResults.sisaTargetPerHari)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(jasaResults.sisaTargetPerHari)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(oilResults.sisaTargetPerHari)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(partResults.sisaTargetPerHari)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(sorderResults.sisaTargetPerHari)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(materialResults.sisaTargetPerHari)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(totalResults.sisaTargetPerHari)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(bookingResults.sisaTargetPerHari)}",
                  ),
                  const TableValue(""),
                ],
              ),
              ...
              DetailTableRow(
                ...
                values: [
                  TableValue(
                    "${numberFormatter.format(siuResults.maksAchvValue)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(jasaResults.maksAchvValue)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(oilResults.maksAchvValue)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(partResults.maksAchvValue)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(sorderResults.maksAchvValue)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(materialResults.maksAchvValue)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(totalResults.maksAchvValue)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(bookingResults.maksAchvValue)}",
                  ),
                  const TableValue(""),
                ],
              ),
              ...
              DetailTableRow(
                ...
                values: [
                  TableValue(
                    "${numberFormatter.format(siuResults.maksAchvPercentage)}%",
                  ),
                  TableValue(
                    "${numberFormatter.format(jasaResults.maksAchvPercentage)}%",
                  ),
                  TableValue(
                    "${numberFormatter.format(oilResults.maksAchvPercentage)}%",
                  ),
                  TableValue(
                    "${numberFormatter.format(partResults.maksAchvPercentage)}%",
                  ),
                  TableValue(
                    "${numberFormatter.format(sorderResults.maksAchvPercentage)}%",
                  ),
                  TableValue(
                    "${numberFormatter.format(materialResults.maksAchvPercentage)}%",
                  ),
                  TableValue(
                    "${numberFormatter.format(totalResults.maksAchvPercentage)}%",
                  ),
                  TableValue(
                    "${numberFormatter.format(bookingResults.maksAchvPercentage)}%",
                  ),
                  const TableValue(""),
                ],
              ),
              ...
              DetailTableRow(
                ...
                values: [
                  TableValue(
                    "${numberFormatter.format(siuResults.dailyBudget)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(jasaResults.dailyBudget)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(oilResults.dailyBudget)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(partResults.dailyBudget)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(sorderResults.dailyBudget)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(materialResults.dailyBudget)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(totalResults.dailyBudget)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(bookingResults.dailyBudget)}",
                  ),
                  const TableValue(""),
                ],
              ),
              ...
              DetailTableRow(
                ...
                values: [
                  TableValue(
                    "${numberFormatter.format(siuResults.growthMonth)}%",
                    " ${numberFormatter.format(databulansebelum.value?.siu ?? 0)} ",
                  ),
                  TableValue(
                    "${numberFormatter.format(jasaResults.growthMonth)}%",
                    " ${numberFormatter.format(databulansebelum.value?.jasa ?? 0)} ",
                  ),
                  TableValue(
                    "${numberFormatter.format(oilResults.growthMonth)}%",
                    " ${numberFormatter.format(databulansebelum.value?.oil ?? 0)} ",
                  ),
                  TableValue(
                    "${numberFormatter.format(partResults.growthMonth)}%",
                    " ${numberFormatter.format(databulansebelum.value?.part ?? 0)} ",
                  ),
                  TableValue(
                    "${numberFormatter.format(sorderResults.growthMonth)}%",
                    " ${numberFormatter.format(databulansebelum.value?.so ?? 0)} ",
                  ),
                  TableValue(
                    "${numberFormatter.format(materialResults.growthMonth)}%",
                    " ${numberFormatter.format(databulansebelum.value?.sm ?? 0)} ",
                  ),
                  TableValue(
                    "${numberFormatter.format(totalResults.growthMonth)}%",
                    " ${numberFormatter.format(databulansebelum.value?.total ?? 0)} ",
                  ),
                  TableValue(
                    "${numberFormatter.format(bookingResults.growthMonth)}%",
                    " ${numberFormatter.format(databulansebelum.value?.booking ?? 0)} ",
                  ),
              ...
              DetailTableRow(
                ...
                values: [
                  TableValue(
                    "${numberFormatter.format(siuResults.growthYear)}%",
                    "${numberFormatter.format(datatahunsebelum.value?.siu ?? 0)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(jasaResults.growthYear)}%",
                    "${numberFormatter.format(datatahunsebelum.value?.jasa ?? 0)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(oilResults.growthYear)}%",
                    "${numberFormatter.format(datatahunsebelum.value?.oil ?? 0)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(partResults.growthYear)}%",
                    "${numberFormatter.format(datatahunsebelum.value?.part ?? 0)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(sorderResults.growthYear)}%",
                    "${numberFormatter.format(datatahunsebelum.value?.so ?? 0)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(materialResults.growthYear)}%",
                    "${numberFormatter.format(datatahunsebelum.value?.sm ?? 0)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(totalResults.growthYear)}%",
                    "${numberFormatter.format(datatahunsebelum.value?.total ?? 0)}",
                  ),
                  TableValue(
                    "${numberFormatter.format(bookingResults.growthYear)}%",
                    "${numberFormatter.format(datatahunsebelum.value?.booking ?? 0)}",
                  ),
